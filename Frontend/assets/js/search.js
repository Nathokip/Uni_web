...
function initMap() {
    ...
    map = L.map('map').setView([-0.395278, 36.9625], 30);
...
async function fetchHostels() {
    try {
        ...
        const response = await fetch(`${API_BASE_URL}/hostels/nearby?lat=-0.395278&long=36.9625`);
